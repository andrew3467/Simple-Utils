package net.iirc.simpleutils.Fluid;
...
public class ModFluidTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY_RL = new ResourceLocation(SimpleUtils.MOD_ID, "misc/in_soap_water");

    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, SimpleUtils.MOD_ID);
